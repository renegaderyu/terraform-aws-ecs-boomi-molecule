...
| <a name="input_logforwarder_buffer_chunk_size"></a> [logforwarder\_buffer\_chunk\_size](#input\_logforwarder\_buffer\_chunk\_size) | The size of the buffer chunk for the logforwarder | `string` | `"1M"` | no |
| <a name="input_logforwarder_buffer_max_size"></a> [logforwarder\_buffer\_max\_size](#input\_logforwarder\_buffer\_max\_size) | The maximum size of the buffer for the logforwarder | `string` | `"24MB"` | no |
| <a name="input_logforwarder_ecs_task_cpu"></a> [logforwarder\_ecs\_task\_cpu](#input\_logforwarder\_ecs\_task\_cpu) | CPU for the logforwarder ECS task definition | `number` | `1024` | no |
| <a name="input_logforwarder_ecs_task_memory"></a> [logforwarder\_ecs\_task\_memory](#input\_logforwarder\_ecs\_task\_memory) | Memory for the logforwarder ECS task definition | `number` | `512` | no |
| <a name="input_logforwarder_log_level"></a> [logforwarder\_log\_level](#input\_logforwarder\_log\_level) | The log level for the logforwarder | `string` | `"info"` | no |
...
| <a name="input_logforwarder_total_file_size"></a> [logforwarder\_total\_file\_size](#input\_logforwarder\_total\_file\_size) | The total size of files dropped into the S3 log bucket | `string` | `"8M"` | no |
| <a name="input_logforwarder_upload_timeout"></a> [logforwarder\_upload\_timeout](#input\_logforwarder\_upload\_timeout) | The timeout for the log upload to S3 | `string` | `"2m"` | no |
